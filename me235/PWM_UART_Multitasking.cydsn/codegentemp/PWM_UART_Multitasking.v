...
module top ;
	...
	cy_clock_v1_0
		#(.id("d51d7e26-9533-45b7-884f-7d5cd54e76a3"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Pin_Servo_Control_net;
	wire [0:0] tmpFB_0__Pin_Servo_Control_net;
	wire [0:0] tmpIO_0__Pin_Servo_Control_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Servo_Control_net;
	electrical [0:0] tmpSIOVREF__Pin_Servo_Control_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pin_Servo_Control
		 (.oe(tmpOE__Pin_Servo_Control_net),
		  .y({Net_270}),
		  .fb({tmpFB_0__Pin_Servo_Control_net[0:0]}),
		  .io({tmpIO_0__Pin_Servo_Control_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Servo_Control_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Servo_Control_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Servo_Control_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    UART_v2_50_1 UART_for_USB (
        .cts_n(1'b0),
        .tx(Net_373),
        .rts_n(Net_386),
        .tx_en(Net_387),
        ...
        .reset(1'b0),
        .rx(Net_378),
        .tx_interrupt(Net_390),
        .rx_interrupt(Net_391),
        .tx_data(Net_392),
        .tx_clk(Net_393),
        .rx_data(Net_394),
        .rx_clk(Net_395));
    defparam UART_for_USB.Address1 = 0;
    defparam UART_for_USB.Address2 = 0;
    defparam UART_for_USB.EnIntRXInterrupt = 0;
    defparam UART_for_USB.EnIntTXInterrupt = 0;
    defparam UART_for_USB.FlowControl = 0;
    defparam UART_for_USB.HalfDuplexEn = 0;
    defparam UART_for_USB.HwTXEnSignal = 1;
    defparam UART_for_USB.NumDataBits = 8;
    defparam UART_for_USB.NumStopBits = 1;
    defparam UART_for_USB.ParityType = 0;
    defparam UART_for_USB.RXEnable = 1;
    defparam UART_for_USB.TXEnable = 1;
